                        ...
                        <table border='0' align='center' cellpadding='0' cellspacing='0' role='presentation' class='row'
                            ...
                            <tr>
                                <td align='center' class='center-text'>
                                    <img style='width:190px;border:0px;display: inline!important;'
                                         src='<?php echo $organizationLogo; ?>' width='190' border='0' alt='intro'>
                                </td>
                            </tr>
                            <tr>
                                <td height='40' style='font-size:40px;line-height:40px;'>&nbsp;</td>
                            ...
                            <tr>
                                <td class='center-text' align='center'
                                    style='font-family:Roboto Slab,Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#333;text-decoration:none;letter-spacing:0px;'>
                            ...
                            <tr>
                                <td class='center-text' align='center'
                                    style='font-family:Roboto Slab,Arial,Helvetica,sans-serif;font-size:26px;line-height:36px;font-weight:400;font-style:normal;color:#C9A47A;text-decoration:none;letter-spacing:0px;'>
                            ...
                            <tr>
                                <td class='center-text' align='center'
                                    style='font-family:Poppins,Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#333;text-decoration:none;letter-spacing:0px;'>

                                    <div>
                                        <br/><br/>


                                        Recuerda que el día del evento debes presentar tu email con el código QR el día
                                        del evento. Esta será tu entrada y es obligatoria para tu acreditación<br/><br/>
                                        <br/><br/>

                                        <br/><br/>

                                        Ese QR mostrará TODAS las entradas que hayas comprado. No es necesario tener una
                                        por cada entrada. Te recordamos estar atento(a) a las medidas sanitarias
                                        requeridas por el evento. Ante cualquier duda contacta a ala organización a:
                                        <b><?php echo $organizationEmail; ?></b>
                                        <br/><br/>
                        ...
                        <table border='0' align='center' cellpadding='0' cellspacing='0' role='presentation' class='row'
                            ...
                            <tr>
                                <td class='center-text' align='center'
                                    ...
                                    <div>
                                        © <?php echo date("Y"); ?> - <?php echo $organizationName; ?>
                                    </div>
